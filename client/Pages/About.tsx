      ...
      <div className="flex p-4">
        <section className="w-3/4 p-4">
          <article className="flex flex-col items-center justify-center">
            <h1 className="font-heading text-heading-lg font-heading-bold text-spamBlue">
              The history of SPAM
            </h1>
            {spamHistory.map((section) => (
              <>
                <section className="m-2 rounded-lg border-2 border-spamBlue p-4">
                  <h2 className="pb-4 font-heading text-heading-md font-heading-regular">
                    {section.title}
                  </h2>
                  <p className="font-body">{section.body}</p>
                </section>
              </>
            ))}
          </article>
          ...
          {images.map((image) => (
            <>
              <img
                ...
                alt={image.alt}
                className="w-80 rounded-lg border-2 border-spamBlue"
              />
